            ...
            <section class="content">
                <div class="slider">
                    ...
                    <div class="slide-container">
                        <div class="slide"><img class="slider__image" src="../media/banner/banner_1.png" alt="Banner">
                        </div>
                        <div class="slide"><img class="slider__image" src="../media/banner/banner_4.png" alt="Banner">
                        </div>
                        <div class="slide"><img class="slider__image" src="../media/banner/banner_7.png" alt="Banner">
                        </div>
                        <div class="slide"><img class="slider__image" src="../media/banner/banner_8.png" alt="Banner">
                        </div>
                    </div>
    ...
    <main class="body">
        ...
        <div id="home-view">
            ...
            <section class="featured-products">
                ...
                <div class="product-list" id="featured-books-list">
                    <!-- Sách nổi bật sẽ được JS chèn vào đây -->
                </div>
            </section>
            ...
            <section class="sale-products">
                ...
                <div class="product-list" id="sale-books-list">
                    <!-- Sách giảm giá sẽ được JS chèn vào đây -->
                </div>
            </section>
            ...
            <!-- Sách giảm giá -->
            <section class="sale-products">
                <h2 class="section-title">Sale Cuối Năm</h2>
                <div class="product-list" id="sale-books-list">
                    <!-- Sách giảm giá sẽ được JS chèn vào đây -->
                </div>
            </section>
            ...
            <!-- Sách giảm giá -->
            <section class="sale-products">
                <h2 class="section-title">Được Đánh Giá Cao</h2>
                <div class="product-list" id="sale-books-list">
                    <!-- Sách giảm giá sẽ được JS chèn vào đây -->
                </div>
            </section>
